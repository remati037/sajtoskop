...
export default async function Page({
  ...
  //
  // [S30, §4.6] Blok „Prvi koraci" je odavde obrisan: traka „Prvih pet minuta"
  // u bočnoj traci je jedini izvor istine o prvom prolazu — dva prikaza istog
  // napretka bi se razišla.
